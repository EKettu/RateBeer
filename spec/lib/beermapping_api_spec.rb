...
describe "BeermappingApi" do
  ...
  it "When HTTP GET returns no entries, an empty array is returned" do
    ...
    stub_request(:get, /.*juankoski/).to_return(body: canned_answer, headers: { 'Content-Type' => "text/xml" })

    places = BeermappingApi.places_in("juankoski")
  ...
  it "When HTTP GET returns several entries, they are parsed and returned" do
    ...
    place2 = places.last
    expect(place2.name).to eq("Simapaja")
